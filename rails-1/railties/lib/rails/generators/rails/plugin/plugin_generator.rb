  ...
  class PluginBuilder
    ...
    def app
      if mountable?
        ...
        template 'app/models/mod.rb'
        template 'app/models/control.rb'
        template 'app/models/function.rb'
        ...
        # template 'db/migrate/migrate_mod.rb'
        # template 'db/migrate/migrate_control.rb'
        # template 'db/migrate/migrate_function.rb' 
      end
    end
